...
const path = require("path") //already exists in node
const React= require("react")
const ReactDOMServer = require("react-dom/server")
const AnimalCard = require("./src/components/AnimalCard").default
// when the app first laiunches, make sure public/uploaded-photos folder exists
...
app.get("/", async(req,res)=>{
    ...
    const generatedHTML = ReactDOMServer.renderToString(
        <div className="container">
            {!allAnimals.length && <p>There are no animals yet, admin should add some.</p>}
